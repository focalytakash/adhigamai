              ...
              <>
                ...
                <div className="row mb-3">
                  <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 candidate-card">
                    <div className="card custom-recharge-card" style={{ color: 'grey', border: 'none' }}>
                      <div className="card-body p-4">
                        <div className="row align-items-center">
                          <div className="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12 mb-3 mb-md-0">
                            <h4 className="text-white mb-3" style={{ fontWeight: 'bold' }}>
                            ...
                            <div className="d-flex flex-wrap gap-2 mb-3">
                              {quickAmounts.map((amount) => (
                                <button
                                  key={amount}
                                  type="button"
                                  className="btn btn-light btn-sm quick-amount-btn"
                                  style={{
                                    minWidth: '80px',
                                    borderRadius: '20px',
                                    fontWeight: '600',
                                    border: customAmount === amount.toString() ? '2px solid #fff' : 'none',
                                    backgroundColor: customAmount === amount.toString() ? '#fff' : 'rgba(255,255,255,0.2)',
                                    color: customAmount === amount.toString() ? '#667eea' : '#fff'
                                  }}
                            ...
                            <div className="input-group recharge-input-group" style={{ maxWidth: '100%' }}>
                              <div className="input-group-prepend">
                                <span className="input-group-text bg-white" style={{ borderRight: 'none', borderRadius: '25px 0 0 25px' }}>
                                  <strong>₹</strong>
                                </span>
                              </div>
                              <input
                                ...
                                min="10"
                                max="100000"
                                style={{ borderLeft: 'none', borderRadius: '0 25px 25px 0', fontSize: '16px', padding: '10px 15px' }}
                              />
                            </div>
                          ...
                          <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 text-center text-md-right">
                            <button
                              type="button"
                              className="btn btn-light btn-lg px-5 py-3 recharge-now-btn"
                              style={{
                                borderRadius: '30px',
                                fontWeight: 'bold',
                                fontSize: '18px',
...
export default WhatsappRecharge;
