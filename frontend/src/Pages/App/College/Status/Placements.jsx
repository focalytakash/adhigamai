...
const handleMoveLeft = async (statusId, currentIndex) => {
  ...
  try {
    ...
    axios.put(`${backendUrl}/college/placementStatus/reorder`, {
      statusOrder
    }, {
...
const handleMoveRight = async (statusId, currentIndex) => {
    ...
    const handleSave = async (statusId, substatusId) => {
      if (title.trim()) {
        if (isSubstatus) {
          if (editMode) {
            // Edit substatus
            const response = await axios.put(`${backendUrl}/college/placementStatus/${statusId}/substatus/${substatusId}`, {
            ...
            // Add substatus
            const response = await axios.post(`${backendUrl}/college/placementStatus/${statusId}/substatus`, {
              title, description, hasRemarks, hasFollowup, hasAttachment
            }, { headers: { 'x-auth': token } });
          ...
          if (editMode && statusId) {
            // Edit status
            const response = await axios.put(`${backendUrl}/college/placementStatus/edit/${statusId}`, {
            ...
            // Add status
            const response = await axios.post(`${backendUrl}/college/placementStatus/add`, {
              title, description,milestone
            }, { headers: { 'x-auth': token } });
  ...
  const handleDrop = async (e, targetIndex) => {
    ...
    try {
      ...
      const response = await axios.put(`${backendUrl}/college/placementStatus/reorder`, {
        statusOrder
      }, {
        headers: { 'x-auth': token }
      });
  ...
  const handleConfirmDelete = async () => {
    if (isDeletingSubstatus) {
      ...
      try {
        ...
        const response = await axios.delete(`${backendUrl}/college/placementStatus/deleteSubStatus/${deletingStatusId}/substatus/${deletingSubstatusId}`, {
          headers: { 'x-auth': token }
        });
      ...
      try {
        ...
        const response = await axios.delete(`${backendUrl}/college/placementStatus/delete/${deletingStatusId}`, {
          headers: { 'x-auth': token }
        });
