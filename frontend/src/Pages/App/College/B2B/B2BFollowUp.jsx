  ...
  const handleMarkAsCompleted = async () => {
    ...
    try {
      const response = await axios.post(`${backendUrl}/api/updatecalendarevent`, {
        ...
        action: 'complete',
        notes: 'Marked as completed via B2B Follow-up Calendar'
      });
  ...
  const submitReschedule = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${backendUrl}/api/updatecalendarevent`, {
        ...
        notes: rescheduleData.notes || 'Event rescheduled via B2B Follow-up Calendar'
      });
    ...
    <div className="container-fluid py-4" style={{ backgroundColor: '#f8f9fa', minHeight: '100vh' }}>
      ...
      <div className="mb-4">
        <div className="d-flex justify-content-between align-items-center">
          <div>
            <h1 className="display-5 fw-bold text-dark mb-2">B2B Follow-up Calendar</h1>
            <p className="text-muted">Manage and track your B2B follow-up events from Google Calendar</p>
          </div>
      ...
      {!userData.googleAuthToken?.accessToken && (
        <div className="alert alert-info d-flex align-items-center" role="alert">
          ...
          <div>
            ...
            <br />
            <small>Connect your Google Calendar to view and manage B2B follow-up events.</small>
          </div>
        </div>
      )}
              ...
              <div className="text-center py-5">
                ...
                <p className="text-muted">
                  {searchTerm || statusFilter !== 'all' 
                    ...
                    : 'No B2B follow-up events found in the selected date range.'}
                </p>
              </div>
            ) : (
              <>
