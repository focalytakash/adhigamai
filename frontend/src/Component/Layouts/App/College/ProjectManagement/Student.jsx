...
const Student = ({
  ...
  const subTabs = [
    { key: "student", label: "Student", count: 0, icon: "bi-people-fill" },
    { key: "classroommedia", label: "Class Room Media", count: 0, icon: "bi-person-check" },
  ];
  ...
  const handleVideosClick = (date, videos) => {
    setSelectedDate(date);
  ...
  return (
    <div className="container-fluid">
                  ...
                  <div key={index} className="d-flex align-items-center gap-1">
                    <button
                      ...
                      style={{
                        ...
                        border: activeSubTab === tab.key ? '2px solid #007bff' : '1px solid #6c757d'
                      }}
                    >
                      {tab.label}
                      {/* <span className={`badge ${activeSubTab === tab.key ? 'bg-light text-primary' : 'bg-secondary'}`}>
                        {subTabCounts[tab.key] || 0}
                      </span> */}
                    </button>
                  </div>
                ))}
                  ...
                  <div className="row">
                    <div className="col-12">
                      <div className="d-flex justify-content-end mb-3">
                        ...
                        >
                          <i className="fas fa-plus me-1"></i>Upload Media
                        </button>
                      </div>
                                      ...
                                      <div className="row align-items-center justify-content-between">
                                        ...
                                        >
                                          <div className="d-flex align-items-center">
                                            ...
                                            {/* <div style={{ marginLeft: "15px" }}>
                                              <p>
                                                Today Attendance Status: <span className="todayStatus"> Present </span>
      ...
      {showImageModal && (
        <div className="modal fade show w-100" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.5)' }}>
          <div className="modal-dialog modal-lg w-100 d-flex justify-content-center" >
            <div className="modal-content p-0">
              <div className="modal-header">
                <h5 className="modal-title">Images - {selectedDate}</h5>
                <button
                  type="button"
                  className="btn-close"
      ...
      {/* Videos Modal */}
      {showVideoModal && (
        <div className="modal fade show w-100" style={{ display: 'flex', justifyContent: 'center', backgroundColor: 'rgba(0,0,0,0.5)' }}>
          <div className="modal-dialog modal-lg w-100 d-flex justify-content-center">
            <div className="modal-content p-0">
              <div className="modal-header">
            ...
            <div className="modal-content p-0">
              ...
              <div className="modal-body">
                <div className="mb-3">
                  ...
                  <DatePicker
                    onChange={setSelectedUploadDate}
...
.date-controls .form-control:focus {
  ...
  .react-date-picker__input-group{
  height:100% !important;
  }
  .react-date-picker__input-group input{
  height:100% !important;
  .MediaGallery .card-actions {
...
.MediaGallery .row .card {
  height: 100%;
  transition: all 0.3s ease;
}

.MediaGallery .row .card:hover {
  transform: translateY(-5px);
}

/* Smaller cards in grid */
.MediaGallery .row .card .card-title {
  font-size: 1.1rem;
  margin-bottom: 1rem;
}

.MediaGallery .row .card .card-body {
  padding: 1.5rem;
}

.MediaGallery .row .card .mb-2 span {
  margin: 3px;
  padding: 6px 12px;
  font-size: 12px;
}
...
.MediaGallery .row .col-lg-4:nth-child(1) .card {
  animation-delay: 0.1s;
}

.MediaGallery .row .col-lg-4:nth-child(2) .card {
  animation-delay: 0.2s;
}

.MediaGallery .row .col-lg-4:nth-child(3) .card {
